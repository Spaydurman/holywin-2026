  ...
  return (
      <section className="details section flex min-h-dvh items-center" id="details" aria-labelledby="details-title">
        <div className="container">
          <motion.div className="section-heading details-heading" {...reveal}><div><span className="kicker">01 / MARK YOUR CALENDAR</span><h2 id="details-title">THE <span>LOWDOWN.</span></h2></div><p>Come together for a joyful evening centered on the promise of John 1:12. Event details are on the way!</p></motion.div>
          <div className="details-grid">
            ...
            <motion.article className="detail-card detail-card-pattern" {...reveal}><div className="detail-card-top"><span className="detail-icon"><Heart size={27} strokeWidth={2.4}/></span><span className="detail-number">03</span></div><div><span className="card-label">WHO'S INVITED?</span><h3>YOU,<br />OF COURSE.</h3><p>Come as you are. Bring a friend, your questions, and an open heart.</p></div><div className="card-bottom">EVERYONE IS WELCOME <ArrowRight size={18}/></div></motion.article>
          </div>
        </div>
      </section>
  )
